...
int for_emscripten_with_node_main(int argc, char** argv) {
    int i, ret;
...
int ffmpeg_convert_main(int argc, char **argv)
{
    int i, ret;
    BenchmarkTimeStamps ti;
//puts("init_dynload");
...
//puts("setvbuf\n");
    setvbuf(stdout,NULL,_IONBF,0); /* win32 runtime needs this */

//puts("av_log_set_flags\n");
    av_log_set_flags(AV_LOG_SKIP_REPEATED);

//puts("avformat_network_init\n");
    avformat_network_init();
...
int ffmpeg_convert_voice_file2wav(char *recfile_path) {
	int _argc;
	char *_argv[6];
	_argc = 6;
	_argv[0] = "ffmpeg";
	_argv[1] = "-i";
	_argv[2] = recfile_path;
	_argv[3] = "-ar";
	_argv[4] = "16000";
	_argv[5] = "mytape.wav";

	stdin_interaction = 0;
	ffmpeg_convert_main(_argc, _argv);
	fflush(stdout);
