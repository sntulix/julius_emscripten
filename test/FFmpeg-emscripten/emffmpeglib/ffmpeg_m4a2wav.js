...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 14213840,
    DYNAMIC_BASE = 19456720,
    DYNAMICTOP_PTR = 14213680;
...
var wasmBinaryFile = 'ffmpeg_m4a2wav.wasm';
...
var ASM_CONSTS = {
  1235: function() {FS.mkdir('/working'); FS.mount(NODEFS, { root: '.' }, '/working');}
};
...
// STATICTOP = STATIC_BASE + 14212816;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=14213696;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 14213744, 4), 14213744);function _gmtime_r(time, tmPtr) {
...
Module['_ff_h264_cabac_tables'] = 719301;
